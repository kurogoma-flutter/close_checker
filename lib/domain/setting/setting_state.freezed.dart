...
mixin _$SettingState {
  String get testKey => throw _privateConstructorUsedError;
...
class _$SettingStateCopyWithImpl<$Res, $Val extends SettingState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      testKey: null == testKey
          ? _value.testKey
          : testKey // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
class _$_SettingState implements _SettingState {
  const _$_SettingState({this.testKey = ''});
  ...
  @override
  String toString() {
    return 'SettingState(testKey: $testKey)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.testKey, testKey) || other.testKey == testKey));
  }

  @override
  int get hashCode => Object.hash(runtimeType, testKey);
...
abstract class _SettingState implements SettingState {
  const factory _SettingState({final String testKey}) = _$_SettingState;
